...
class WebdriverSettings(Settings):
    ...
    def load_settings(self) -> dict:
        ...
        with open(BASE_DIR / settings_paths_dict['webdriver_config_path']) as webdriver_settings:
    ...
    def update_settings(self, updated_config: dict):
        settings_paths_dict = self.load_main_settings()
        with open(BASE_DIR / settings_paths_dict['webdriver_config_path'], 'w') as webdriver_settings:
